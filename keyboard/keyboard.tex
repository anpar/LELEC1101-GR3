...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.55]{img-keyboard/keyboard-circuit.png}
...
à lui les valeurs mesurées de la tension out avec l'erreur
relative par rapport à la tension esperée. Les imprécisions
...
\begin{table}[ht]
	...
	bonnes résistances. Les erreurs relatives ont été calculées par comparaison avec
