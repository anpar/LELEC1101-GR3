...
% TODO : remplacer avec les nouvelles valeurs (voir sigma.m)
% L'énoncé n'était pas très bien formulé, la fréquence maximale
% doit en fait être de 80kHz (le Vref de l'énoncé désigne le Vref
% du schéma bloc) pour Vref (du circuit cette fois) = 0V.
