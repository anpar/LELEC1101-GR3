...
\begin{itemize}
	\item le contrôleur de l'intégrateur (\textit{integrator controller} sur la figure 
	\ref{fig:schema_bloc_vco}) qui se compose lui-même d'un switch et d'un sommateur (summing sur la figure);
